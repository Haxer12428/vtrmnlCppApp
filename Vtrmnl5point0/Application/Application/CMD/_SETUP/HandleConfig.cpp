...
const void Cmd::SETUP_CONFIG_HANDLE(
	...
	const int VERTICAL_SLIDER_RESERVED_SPACE = std::stoi(this->Config->Desire("$VERTICAL_SLIDER_RESERVED_SPACE", "15"));
	...
	const std::vector<std::string> COMMAND_LINE_FONT_INFO = Engine::String::GetVector(this->Config->Desire("$COMMAND_LINE_FONT", "Hack,11"));
	this->SETUP_COMMAND_LINE_FONT(COMMAND_LINE_FONT_INFO[0], std::stoi(COMMAND_LINE_FONT_INFO[1]));

	const std::vector<int> COMMAND_LINE_DEFAULT_COLOR = Engine::Vector::TransformStringToInt(Engine::String::GetVector(this->Config->Desire("$COMMAND_LINE_DEFAULT_COLOR", "255,255,255")));
	this->SETUP_COMMAND_LINE_DEFAULT_COLOR(COMMAND_LINE_DEFAULT_COLOR[0], COMMAND_LINE_DEFAULT_COLOR[1], COMMAND_LINE_DEFAULT_COLOR[2]);

	const std::vector<int> COMMAND_LINE_DIFFERENCE_BETWEEN_EDGES = Engine::Vector::TransformStringToInt(Engine::String::GetVector(this->Config->Desire("$COMMAND_LINE_DIFFERENCE_BETWEEN_EDGES", "10, 10")));
	this->SETUP_COMMAND_LINE_DIFFERENCE_BETWEEN_EDGES(COMMAND_LINE_DIFFERENCE_BETWEEN_EDGES[0], COMMAND_LINE_DIFFERENCE_BETWEEN_EDGES[1]);

	const int COMMAND_LINE_DIFFERENCE_BETWEEN_LINES = std::stoi(this->Config->Desire("$COMMAND_LINE_DIFFERENCE_BETWEEN_LINES", "4"));
	this->SETUP_COMMAND_LINE_DIFFERENCE_BETWEEN_LINES(COMMAND_LINE_DIFFERENCE_BETWEEN_LINES);
}